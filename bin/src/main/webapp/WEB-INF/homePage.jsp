			...
			<div class="w-100 d-flex justify-content-between">
				<div>
					<i class="fa fa-envelope mx-2"></i> <a
						...
						href="mailto:info@company.com">info@revea.com</a> <i
					...
					<c:choose>
						<c:when test="${myUserId}">
							<a class="nav-icon position-relative text-decoration-none"
								...
								class="position-absolute top-0 left-100 translate-middle badge rounded-pill bg-light text-dark"><c:out
										value="${size}"></c:out></span>
							</a>
							<a class="nav-icon position-relative text-decoration-none"
								href="/"> <i class="fa fa-fw fa-user text-dark mr-3"></i> <a
								href="/logout" style="text-decoration: none">Logout</a>
							</a>
						</c:when>
						<c:otherwise>
							...
							<a class="nav-icon position-relative text-decoration-none"
								href="/"> <i class="fa fa-fw fa-user text-dark mr-3"></i> <a
								href="/login" style="text-decoration: none">Login</a>
							</a>
					...
					<div class="row p-5">
						...
						<div class="col-lg-6 mb-0 d-flex align-items-center">
							<div class="text-align-left">
								...
								<p>
								<p>Fill your home without emptying the wallet.</p>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row p-5">
						...
						<div class="col-lg-6 mb-0 d-flex align-items-center">
							<div class="text-align-left">
								...
								<p>
								<p>Choose different, choose US.</p>
							</div>
						</div>
					</div>
				</div>
	...
	<section class="container py-5">
		...
		<div class="row">
			<div class="col-12 col-md-4 p-5 mt-3">
				<a href="#"><img src="/images/2t.webp"
					class="rounded-circle img-fluid border"></a>
				<h5 class="text-center mt-3 mb-3">
					<c:out value="${category1.name}" />
				</h5>
				<p class="text-center">
					<a class="btn btn-success" href="/categories/${category1.id}">Go
						Shop</a>
				</p>
			</div>
			<div class="col-12 col-md-4 p-5 mt-3">
				<a href="#"><img src="/images/5.webp"
					class="rounded-circle img-fluid border"></a>
				<h2 class="h5 text-center mt-3 mb-3">
					<c:out value="${category2.name}" />
				</h2>
				<p class="text-center">
					<a class="btn btn-success" href="/categories/${category2.id}">Go
						Shop</a>
				</p>
			</div>
			<div class="col-12 col-md-4 p-5 mt-3">
				<a href="#"><img src="/images/1s.webp"
					class="rounded-circle img-fluid border"></a>
				<h2 class="h5 text-center mt-3 mb-3">
					<c:out value="${category3.name}" />
				</h2>
				<p class="text-center">
					<a class="btn btn-success" href="/categories/${category3.id}">Go
						Shop</a>
				</p>
			</div>
		</div>
	...
	<footer class="bg-dark" id="tempaltemo_footer">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4 pt-5">
					<h2 class="h2 text-success border-bottom pb-3 border-light logo">Revea
						Shop</h2>
					<ul class="list-unstyled text-light footer-link-list">
						<li><i class="fas fa-map-marker-alt fa-fw"></i>
							Jenin,Palestine</li>
						<li><i class="fa fa-phone fa-fw"></i> <a
							class="text-decoration-none" href="/">010-020-0340</a></li>
						<li><i class="fa fa-envelope fa-fw"></i> <a
							class="text-decoration-none" href="/">info@revea.com</a></li>
					</ul>
				</div>
				...
				<div class="col-md-4 pt-5">
					...
					<ul class="list-unstyled text-light footer-link-list">
						...
						<li><a class="text-decoration-none" href="/about">About
								Us</a></li>
		...
		<div class="w-100 bg-black py-3">
			<div class="container">
				<div class="row pt-2">
					<div class="col-12">
						<p class="text-left text-light">Copyright &copy; 2021 REVEA</p>
					</div>
				</div>
			</div>
		</div>
